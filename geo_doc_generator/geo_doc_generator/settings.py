"""
Django settings for geo_doc_generator project.
...
INSTALLED_APPS = [
    "geodetic_work.apps.GeodeticWorkConfig",
...
ROOT_URLCONF = "geo_doc_generator.urls"
...
WSGI_APPLICATION = "geo_doc_generator.wsgi.application"
