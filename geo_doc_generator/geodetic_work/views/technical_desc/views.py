...
class TechnicalDescriptionCreateView(
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(self.request, "Dodałeś dokument: Sprawozdanie techniczne")
...
class TechnicalDescriptionUpdateView(
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(
            self.request, "Zmieniłeś dane dokumentu: Sprawozdanie techniczne"
        )
        return redirect("geodetic-work-details", work_id)
