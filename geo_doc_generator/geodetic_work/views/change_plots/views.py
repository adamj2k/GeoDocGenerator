...
class ChangePlotsCreateView(CreateView, LoginRequiredMixin, UserPassesTestMixin):
    model = ChangeListPlot
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "Dodałeś dokument: Wykaz zmian danych ewidencyjnych dot. działki",
        )
...
class ChangePlotsUpdateView(UpdateView, LoginRequiredMixin, UserPassesTestMixin):
    model = ChangeListPlot
    template_name = "geodetic_work/document_create.html"
    fields = "__all__"
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "Zmieniłeś dane dokumentu: Wykaz zmian danych ewidencyjnych dot. działki",
        )
        return redirect("geodetic-work-details", work_id)
