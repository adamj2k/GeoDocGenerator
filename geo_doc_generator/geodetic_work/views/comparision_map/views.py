...
class ComparisionMapCreateView(CreateView, LoginRequiredMixin, UserPassesTestMixin):
    model = ComaparisionMap
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(self.request, "Dodałeś dokument: Mapa porównania z terenem")
...
class ComparisionMapUpdateView(UpdateView, LoginRequiredMixin, UserPassesTestMixin):
    model = ComaparisionMap
    template_name = "geodetic_work/document_create.html"
    fields = "__all__"
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(
            self.request, "Zmieniłeś dane dokumentu: Mapa porównania z terenem"
        )
        return redirect("geodetic-work-details", work_id)
