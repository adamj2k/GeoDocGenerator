...
class GeodeticNetworkDraftCreateView(
    CreateView, LoginRequiredMixin, UserPassesTestMixin
):
    model = GeodeticNetworkDraft
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(self.request, "Dodałeś dokument: Szkic osnowy pomiarowej")
...
class GeodeticNetworkDraftUpdateView(
    ...
    def form_valid(self, form):
        ...
        form.save()
        messages.success(
            self.request, "Zmieniłeś dane dokumentu: Szkic osnowy pomiarowej"
        )
        return redirect("geodetic-work-details", work_id)
