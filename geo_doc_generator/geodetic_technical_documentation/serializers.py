...
class GeodeticWorkDocumentsSerializer:
    ...
    def serialize(self):
        ...
        return {
            ...
            "work_scope": self.instance.get_work_scope_display(),
            ...
            "company_name": self.instance.contractor.company_name,
            "adress1": self.instance.contractor.adress1,
            "adress2": self.instance.contractor.adress2,
            "company_phone": self.instance.contractor.company_phone,
            "nip_number": self.instance.contractor.nip_number,
            "licenced_surveyors": self.instance.contractor.licenced_surveyors,
            "regural_surveyors": self.instance.contractor.regural_surveyors,
        }
